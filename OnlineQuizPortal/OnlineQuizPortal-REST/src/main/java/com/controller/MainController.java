...
public class MainController {
	...
	//http://localhost:8080/mcq/getUser
	...
	//http://localhost:8080/mcq/getQuestions
	@GetMapping(value="getQuestions", consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	//http://localhost:8080/mcq/getQuiz
	@GetMapping(value="getQuiz", consumes = MediaType.APPLICATION_JSON_VALUE)
